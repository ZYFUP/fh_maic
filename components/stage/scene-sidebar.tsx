  ...
  return (
    ...
    >
      ...
      <div className={cn('flex flex-col w-full h-full overflow-hidden', collapsed && 'hidden')}>
        {/* Logo Header */}
        <div className="h-14 flex items-center shrink-0 relative mt-3 mb-1 px-3">
          <button
            onClick={() => router.push('/')}
            className="absolute left-1/2 -translate-x-1/2 flex items-center justify-center gap-2 cursor-pointer rounded-lg px-5 py-2 hover:bg-gray-100/80 dark:hover:bg-gray-800/60 active:scale-[0.97] transition-all duration-150 min-w-[120px]"
